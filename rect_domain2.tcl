...
#---------------------------------------------------------
pfset GeomInput.Names "domain_input background_input b1_input b2_input"
...
# B1 Geometry Input
#---------------------------------------------------------
pfset GeomInput.b1_input.InputType         Box
pfset GeomInput.b1_input.GeomName          b1

#---------------------------------------------------------
# b1 Geometry
#---------------------------------------------------------
pfset Geom.b1.Lower.X -99999999.0
pfset Geom.b1.Lower.Y -99999999.0
pfset Geom.b1.Lower.Z -99999999.0

pfset Geom.b1.Upper.X  99999999.0
pfset Geom.b1.Upper.Y  99999999.0
pfset Geom.b1.Upper.Z  0.0

#---------------------------------------------------------
# B1 Geometry Input
#---------------------------------------------------------
pfset GeomInput.b2_input.InputType         Box
pfset GeomInput.b2_input.GeomName          b2

#---------------------------------------------------------
# b2 Geometry
#---------------------------------------------------------
pfset Geom.b2.Lower.X -99999999.0
pfset Geom.b2.Lower.Y -99999999.0
pfset Geom.b2.Lower.Z 0.0

pfset Geom.b2.Upper.X  99999999.0
pfset Geom.b2.Upper.Y  99999999.0
pfset Geom.b2.Upper.Z  99999999.0

#-----------------------------------------------------------------------------
# Perm
#-----------------------------------------------------------------------------
pfset Geom.Perm.Names "b1 b2"

pfset Geom.b1.Perm.Type     Constant
pfset Geom.b1.Perm.Value    5.0

pfset Geom.b2.Perm.Type     Constant
pfset Geom.b2.Perm.Value    5.0
