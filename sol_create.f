...
nx_dem = 200   ! num dem pnts in x
ny_dem = 20    ! num dem pnts in y
...
dem = 20.            ! elevation of the top of the domain, init to 0.

dem_filename = 'PBridge.txt'

!pfsol_filename = 'lw.1km.big.pfsol'
pfsol_filename = 'test_output.pfsol'
